...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://192.168.28.128:8083/rest/item/cat/list?callback=category.getDataService",
		URL_Serv: "http://rest.supermarket.com/rest/item/cat/list?callback=category.getDataService",
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	//使用jsonp来实现跨域请求,请求js片段，采用回调方法，立即取出js中包含的js数据
