 ...
 */
function login() {
	//return location.href = "http://192.168.28.128:8085/sso/page/login";
    return location.href = "http://sso.supermarket.com/sso/page/login";
}
function regist() {
    //return location.href = "http://192.168.28.128:8085/sso/page/register";
	return location.href = "http://sso.supermarket.com/sso/page/register";
}
...
function search(a) {
    //var b = "http://192.168.28.132:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
	var b = "http://www.supermarket.com/search.html?q=" + encodeURIComponent(encodeURIComponent(document.getElementById(a).value));
