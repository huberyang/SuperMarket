...
public class LoginServiceImpl implements LoginService {
	...
	public SmResult login(String username, String password, HttpServletRequest request, HttpServletResponse response) {
		...
		//username and password are right, so we need to save user's info into redis cache(generate token)
		...
		//save the token to the cookie,so that browser can use it to check user's login status
